...
<!-- Metrics -->
        <div class="w3-row">
          ...
          <div class ="w3-container w3-border w3-border-green w3-round-large" id ="customer-cont" style = "width:100%; height:400px">
          <h2> Customer </h2><br>
        ...
        <div class = "w3-display-bottommiddle w3-padding w3-hide-tiny"><span class = "nowrap">Technologies Promoted</span></div>
          ...
          <div class="w3-col l6 w3-padding">
          <div class ="w3-container w3-border w3-border-green w3-round-large" id ="financial-cont" style = "width:100%; height:400px">
          <h2>  Financial </h2><br>
